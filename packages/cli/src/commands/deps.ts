...
export const depsCommand = new Command('deps')
  ...
  .action(async (symbolName: string, projectPath: string, options: any) => {
...
async function performDependencyAnalysis(analyzer: any, symbol: string, options: any): Promise<any[]> {
