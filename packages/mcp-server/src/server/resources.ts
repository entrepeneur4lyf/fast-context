...
export function registerResources(server: McpServer): void {
  ...
  server.registerResource(
    'codebase-analysis',
    new ResourceTemplate(RESOURCE_PATTERNS.CODEBASE_ANALYSIS, { list: undefined }),
    {
  ...
  server.registerResource(
    'symbol-info',
    new ResourceTemplate(RESOURCE_PATTERNS.SYMBOL_INFO, { list: undefined }),
    {
  ...
  server.registerResource(
    'dependencies',
    new ResourceTemplate(RESOURCE_PATTERNS.DEPENDENCIES, { list: undefined }),
    {
  ...
  server.registerResource(
    'file-analysis',
    new ResourceTemplate(RESOURCE_PATTERNS.FILE_ANALYSIS, { list: undefined }),
    {
      title: 'File Analysis',
